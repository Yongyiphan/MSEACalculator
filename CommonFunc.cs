...
namespace MSEACalculator
{
    class CommonFunc
    {
        public static async Task<Dictionary<int, Boss>> GetBossListAsync()
        {
            ...
            StorageFile statTable = await storageFolder.GetFileAsync(@"\Data\BossListData.csv");
        ...
        public static async Task<Dictionary<int, SFGain>> GetSFListAsync()
        {
            ...
            StorageFile statTable = await storageFolder.GetFileAsync(@"\Data\statGains.csv");
        ...
        public static async Task<List<EventRecords>> retrieveEventJson()
        {
            ...
            string jsonFP = Path.Combine(ApplicationData.Current.LocalFolder.Path, @"Data\Event.json");
